...
- `argocd-secret` is Helm-managed but updated by an ExternalSecret; Argo CD ignores `metadata.annotations.argocd.argoproj.io/tracking-id` on that Secret to prevent drift.
