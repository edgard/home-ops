...
@test "external-secrets-postsync reapplies store and restarts controller" {
  ...
  [ "$status" -eq 0 ]
  assert_log_contains 'kubectl apply -f /Users/edgard/Documents/Projects/Personal/home-ops/apps/platform-system/external-secrets/manifests/external-secrets-store.clustersecretstore.yaml'
